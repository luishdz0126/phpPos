...
if(localStorage.getItem("capturarRango") != null){
	...
	$("#daterage-btn span").html(localStorage.getItem("capturarRango"));

}else{

	$("#daterage-btn span").html('<i class="fa fa-calendar"</i>Rango de fecha')
...
$(".formularioVenta").on("click", "button.quitarProducto", function(){
	...
	if($(".nuevoProducto .row").children().length == 3){
		...
		swal({
			  title: "Error",
			  text: "La venta no puede quedarse sin productos",
			  type: "error",
			  confirmButtonText: "¡Cerrar!"
			});
...
// PONER FORMATO AL PRECIO FINAL DE LOS PRODUCTOS
